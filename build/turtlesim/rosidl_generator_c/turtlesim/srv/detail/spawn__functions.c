...
turtlesim__srv__Spawn_Request__create(void)
{
...
turtlesim__srv__Spawn_Request__Sequence__init(turtlesim__srv__Spawn_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(turtlesim__srv__Spawn_Request)) {
      return false;
    }
  ...
  turtlesim__srv__Spawn_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(turtlesim__srv__Spawn_Request)) {
      return false;
    }
...
turtlesim__srv__Spawn_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
turtlesim__srv__Spawn_Response__Sequence__init(turtlesim__srv__Spawn_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(turtlesim__srv__Spawn_Response)) {
      return false;
    }
  ...
  turtlesim__srv__Spawn_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(turtlesim__srv__Spawn_Response)) {
      return false;
    }
    const size_t allocation_size =
...
turtlesim__srv__Spawn_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
turtlesim__srv__Spawn_Event__Sequence__init(turtlesim__srv__Spawn_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(turtlesim__srv__Spawn_Event)) {
      return false;
    }
  ...
  turtlesim__srv__Spawn_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(turtlesim__srv__Spawn_Event)) {
      return false;
    }
    const size_t allocation_size =
